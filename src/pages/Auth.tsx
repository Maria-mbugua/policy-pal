    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold tracking-tight">Policy Oracle</h1>
          <p className="text-muted-foreground">AI-powered policy & compliance assistant</p>
        </div>
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription>
              {isLogin ? "Enter your credentials to access the platform" : "Fill in your details to get started"}
            </CardDescription>
          </CardHeader>
          <CardContent>
